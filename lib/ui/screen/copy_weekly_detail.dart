...
class CopyWeeklyDetail extends GetView<CopyWeeklyController> {
  const CopyWeeklyDetail({
    Key? key,
  }) : super(key: key);
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          "Week : ${controller.weekly[0].week} <> Tahun : ${controller.weekly[0].year}",
                          style: blackFontStyle2,
                        ),
                        Text(
                          "${controller.weekly.length} Task",
                    ...
                    ...controller.weekly.map((e) => _task(e)).toList()
                  ],
                ),
              ),
            ],
