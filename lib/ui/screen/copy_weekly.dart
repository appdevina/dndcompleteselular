...
class CopyWeekly extends StatelessWidget {
  final controller = Get.put(CopyWeeklyController());
  CopyWeekly({Key? key}) : super(key: key);
      ...
      body: ListView(
        children: [
          ...
          Container(
            ...
            child: GetBuilder<CopyWeeklyController>(
                id: 'weekly',
                builder: (_) => MyButton(
                    label: controller.weekly.isEmpty ? "No Data" : "Details",
                    onTap: controller.weekly.isEmpty
                        ? () {}
                        : () => Get.to(() => const CopyWeeklyDetail(),
  ...
  _dialogDelete(BuildContext context) {
    return AlertDialog(
      ...
      content: Text(
        'Apakah anda yakin menduplikat weekly ?',
