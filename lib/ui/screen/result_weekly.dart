...
class ResultWeekly extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                  _cardDetail("Total Task", '5', context),
              ...
              //     child: Text(
              //       "Detail",
              //       style: blackFontStyle3.copyWith(color: Colors.white70),
              //     ))
            ],
          ),
        ),
